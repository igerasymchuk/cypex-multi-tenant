...
INSERT INTO public.org (id, name, slug) VALUES
    ...
    ('a0000000-0000-0000-0000-000000000002', 'Ivan Corp', 'ivan-corp')
...
INSERT INTO public.note (id, org_id, author_id, title, body) VALUES
    (
        ...
        'a0000000-0000-0000-0000-000000000002',
        'a1000000-0000-0000-0000-000000000001',  -- ivan (admin)
    ...
    (
        ...
        'a0000000-0000-0000-0000-000000000002',
        'a1000000-0000-0000-0000-000000000002',  -- bob (editor)
...
-- │ Email                │ Role   │ User ID                              │
-- ├──────────────────────┼────────┼──────────────────────────────────────┤
-- │ ivan@corp.com        │ admin  │ a1000000-0000-0000-0000-000000000001 │
-- │ bob@corp.com         │ editor │ a1000000-0000-0000-0000-000000000002 │
-- └──────────────────────┴────────┴──────────────────────────────────────┘
--
